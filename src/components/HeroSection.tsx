          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-6 md:mt-8 animate-slideUp animation-delay-600">
              <a 
                ...
                className="group inline-flex items-center bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-black px-6 py-3 md:px-8 md:py-4 rounded-md transition-all transform hover:scale-105 text-sm md:text-base font-semibold shadow-lg shadow-gold-500/50"
              >
