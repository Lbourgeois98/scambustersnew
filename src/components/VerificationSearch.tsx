        ...
        <div className="p-6">
          <form onSubmit={handleSearch} className="mb-6">
            ...
            <button
              ...
              className={`mt-4 w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-medium py-3 px-4 rounded-lg transition-all shadow-lg ${isSearching ? 'opacity-75 cursor-not-allowed' : ''}`}
            >
              {isSearching ? (
